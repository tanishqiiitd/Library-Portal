            ...
            if(enter==1) {                 //librarian actions
                ...
                while(true) {
                    ...
                    if (action<1 || action>7) {
                        ...
                        boolean memcheckk = false;
                        for (Member m : Memberlist) {
                            if (namee.equals(m.name) && phone.equals(m.phone)) {
                                System.out.println("------------------");
                                System.out.println("User with this phone no already exists.");
                                System.out.println("------------------");
                                memcheckk = true;
                            }
                        }
                        ...
                        for (int i=0; i<copy; i++) {
                            Book book1 = new Book(bkname, author, bookid, status, 0);
                            bookid++;
                ...
                if (membercheck == true) {
                    ...
                    while (true) {
                        ...
                        if (action<1 || action>6) {
                            ...
                            boolean limit = false;    //true-limit reached, false-limit not reached

                            for (Member member : Memberlist) {
                                
                                if (name.equals(member.name) && phone.equals(member.phone)) {  
                                    
                                    if (member.issuedbooks.size() >= 2) {
                                        limit = true;
                                        break;
                                    }
                                }
                            ...
                            boolean finecheck = false;
                            
                            for (Member memm : Memberlist) {
                                if (name.equals(memm.name) && phone.equals(memm.phone) && memm.fine == 0) {
                            ...
                            else if (finecheck==false) {

                                System.out.println("You have pending fine. Please pay it first.");
                            } 
                            
                            else if (checkbook == true && limit == false && finecheck == true) {
                                for (Book book : bookshelf) {
                                    if ((boookid)==book.id && (bkname).equals((book.name))) {
                                        ...
                                        for (Member member : Memberlist){
                                            if (name.equals(member.name) && phone.equals(member.phone)) {
                                                ...
                                                book.seconds = timeinseconds;   // add time here
                                ...
                                if (name.equals(member.name) && phone.equals(member.phone)) {
                                    ...
                                    for (Book book : member.issuedbooks) {
                                        if (book.id == bokid) {
                                            ...
                                            int days = returntime - book.seconds;
                                            if (days>10) {
                                                int fin = (days-10)*3;
                                                System.out.printf("Book ID: %d successfully returned. %d Rupees has been charged for a delay of %d days.\n", bokid, fin, (days-10));
                                                member.fine = member.fine+fin;
                                            }
